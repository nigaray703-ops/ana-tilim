...
const vocabTopicDefinitions = [
  {
    ...
    words: [
      ...
      ["xeyirlik-etigen", "خەيرلىك ئەتىگەن", "xeyrlik etigen", "早上好"],
      ["xeyirlik-kech", "خەيرلىك كەچ", "xeyrlik kech", "晚上好"],
  ...
  },
  {
    ...
    words: [
      ...
      ["apa-family", "ئاپا", "apa", "妈妈；姐姐（依地区和称呼语境）", ["ئا", "پ", "ا"], "和 ئانا 比较：中间是 پ。"],
  ...
  },
  {
    ...
    words: [
      ...
      ["yekshembe", "يەكشەنبە", "yekshenbe", "星期日"],
      ...
      ["sentyabr", "سېنتەبىر", "sëntebir", "九月"],
      ["oktyabr", "ئۆكتەبىر", "öktebir", "十月"],
  ...
  },
  {
    ...
    words: [
      ...
      ["may-food", "ماي", "may", "油、脂肪"],
      ["sut-food", "سۈت", "süt", "牛奶"],
      ["tuxum-food", "تۇخۇم", "tuxum", "蛋、鸡蛋"],
  ...
  },
  {
    ...
    words: [
      ...
      ["kala-animal", "كالا", "kala", "牛、牛类", ["ك", "ا", "لا"]],
      ...
      ["chashqan-animal", "چاشقان", "chashqan", "老鼠（小鼠或大鼠）"],
      ["toshqan-animal", "توشقان", "toshqan", "兔子、野兔"],
  ...
  },
  {
    ...
    words: [
      ...
      ["korush-action", "كۆرۈش", "körüsh", "看见、见面"],
